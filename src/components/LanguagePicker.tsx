...
export const darkTheme: LanguagePickerTheme = {
    ...
    list: 'absolute left-0 z-50 bg-slate-900 border border-slate-700 rounded-lg p-1.5 list-none shadow-2xl max-h-60 overflow-y-auto min-w-full w-max max-w-[90vw] language-picker-scroll',
