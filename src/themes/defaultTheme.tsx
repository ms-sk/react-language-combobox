...
export const defaultTheme: LanguageComboBoxClass = {
    ...
    listClass: 'absolute left-0 top-full mt-1 z-50 bg-white border border-gray-200 rounded-lg p-1.5 list-none shadow-xl max-h-60 overflow-y-auto w-full language-combobox-scroll scroll-smooth',
