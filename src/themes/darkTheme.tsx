...
export const darkTheme: LanguageComboBoxClass = {
    ...
    listClass: 'absolute left-0 top-full mt-1 z-50 bg-slate-900 border border-slate-700 rounded-lg p-1.5 list-none shadow-2xl max-h-60 overflow-y-auto w-full language-combobox-scroll',
